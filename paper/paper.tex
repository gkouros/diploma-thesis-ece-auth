...
\begin{figure}[!ht]
	\centering
	\subfloat[The SLAM map, global path (green) and trajectory (red))]{\includegraphics[width=\linewidth]{Figures/zic_zac_room.png}}\\%
...
\begin{figure}[!ht]
	\centering
	\frame{\includegraphics[width=0.94\linewidth]{Figures/exploration_exp.png}}%
