...
\begin{figure}[!ht]
	...
	\hspace{0.01\linewidth}
	\subfloat[Μη αντιλήψιμα και μη προσπελάσιμα εμπόδια.]{\includegraphics[width=0.32\linewidth, height=3.5cm]{Chapters/Chapter5/Figures/stepfield.png}}
...
\begin{figure}[!ht]
	...
	\subfloat[Χάρτης μέσω CRSM-SLAM.]{\frame{\includegraphics[height=7.5cm]{Chapters/Chapter5/Figures/csal_crsm_map.png}}}
	\hspace{1.0cm}
