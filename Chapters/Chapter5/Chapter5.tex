...
%\begin{figure}[!ht]
%	\centering
%	\includegraphics[width=\linewidth]{Chapters/Chapter5/Figures/pandora_circuit.png}
...
\textbf{TODO: Προσθήκη φωτογραφίας εργαστηρίου αρχιτεκτονικής υπολογιστών και αντίστοιχων χαρτών.}

%\begin{figure}[!ht]
%	\centering
%	\subfloat[Εργαστήριο Αρχιτεκτονικής και Υπολογιστών.]{\includegraphics[height=6.5cm]{Chapters/Chapter5/Figures/computer_architecture_lab.png}}\\
%	\subfloat[Χάρτης μέσω CRSM-SLAM.]{\includegraphics[height=7cm]{Chapters/Chapter5/Figures/computer_architecture_lab_crsm_map.png}}\\
%	\subfloat[Χάρτης μέσω Gmapping.]{\includegraphics[height=7cm]{Chapters/Chapter5/Figures/computer_archtecture_lab_gmapping_map.png}}
%	\caption{Εργαστήριο Αρχιτεκτονικής και Υπολογιστών, Τμήματος ΗΜΜΥ, ΑΠΘ και οι αντίστοιχοι χάρτες που κατασκευάστηκαν.}
...
\begin{table}[!ht]
	\centering
	\captionof{table}{Οι πόζες - στόχοι των πειραμάτων κατασκευής μονοπατιών\\ στο περιβάλλον sparse{\_}obstacles.}
...
\subsection{Παραμόρφωσης Μονοπατιού με τον Αλγορίθμου Reeds-Shepp Band}\label{ssec:rsband_experiments}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Πειράματα Διάσχισης Μονοπατιού} \label{ssec:path_tracking_experiments}
...
\subsubsection{Διάσχιση Μονοπατιού σε Ομαλό Έδαφος}
...
%----------------------------------------------------------------------------------------
%	SECTION 4: Exploration Experiments
%----------------------------------------------------------------------------------------
%\section{Πειράματα Αυτόνομης Εξερεύνηση Χώρου} \label{exploration_experiments}
%Στην παρούσα ενότητα, πραγματοποιούνται πειράματα αυτόνομης εξερεύνησης, χωρίς εκ των προτέρων  γνωστό περιβάλλον, μέσω των συστημάτων αυτόνομης πλοήγησης με δυναμική παραμόρφωση μονοπατιού και δυναμική ανακατασκευή μονοπατιού, ενώ, για την χαρτογράφηση και τον εντοπισμό θέσης, χρησιμοποιείται ο αλγόριθμος CRSM-SLAM. Τα πειράματα εξερεύνησης πραγματοποιήθηκαν στον 2D προσομοιωτή STDR, στην αρένα robocup που παρέχεται από τον προσομοιωτή, όπως αυτή παρουσιάστηκε στο σχήμα \ref{fig:stdr_robocup}. 
%
%\bigskip
...
%\begin{figure}[!ht]
%	\centering
%	\subfloat[]{\includegraphics[width=0.475\linewidth]{Chapters/Chapter5/Figures/exploration_dpm.png}}
%	\subfloat[]{\includegraphics[width=0.475\linewidth]{Chapters/Chapter5/Figures/exploration_dpr.png}}
%	\caption{Τροχιές που διανύθηκαν για την πλήρη εξερεύνηση του περιβάλλοντος robocup, μέσω των συστημάτων αυτόνομης πλοήγησης με (α')δυναμική παραμόρφωση μονοπατιού και (β')δυναμική ανακατασκευή μονοπατιού.}
%	\label{fig:exploration_experiments}
%\end{figure}


%----------------------------------------------------------------------------------------
%	SECTION 4: Dynamic Obstacle Avoidance Experiments
%----------------------------------------------------------------------------------------
